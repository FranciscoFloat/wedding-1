const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/lottie-react.esm-CQJMxadg.js","assets/index-CCudEAK0.js"])))=>i.map(i=>d[i]);
import { i as __toESM, n as require_jsx_runtime, r as require_react, t as __vitePreload } from "./index-CCudEAK0.js";
//#region src/components/wedding/Countdown.tsx
...
//#endregion
//#region src/components/wedding/RSVPForm.tsx
function RSVPForm() {
...
* @author: Jack Doyle, jack@greensock.com
*/
var _win$2, _doc$2, _docElement, _pluginInitted, _tempDiv, _recentSetterPlugin, _reverting, _windowExists$1 = function _windowExists() {
	return typeof window !== "undefined";
	...
	cache.renderTransform(ratio, cache);
}, _transformProp$1 = "transform", _transformOriginProp = _transformProp$1 + "Origin", _saveStyle = function _saveStyle(property, isNotCSS) {
	var _this = this;
...
//#endregion
//#region src/components/wedding/SmoothScroll.tsx
/**
...
//#endregion
//#region src/components/wedding/WeddingLanding.tsx
...
function LottieBottom({ url, className = "" }) {
	...
	(0, import_react.useEffect)(() => {
		__vitePreload(() => import("./lottie-react.esm-CQJMxadg.js").then((module) => {
			setPlayerComp(() => module.Player);
		}), __vite__mapDeps([0,1])).catch(console.error);
	}, []);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
